...
(
	...
	GROUP BY vervoerdercode,lijnsysteemnr,richting,ritnummer) as y
        where x.vervoerdercode = y.vervoerdercode AND x.lijnsysteemnr = y.lijnsysteemnr AND x.richting = y.richting AND x.ritnummer = y.ritnummer AND 
x.stopsequentie = y.stopsequentie
) as e,
