...
SELECT
'QBUZZ' as agency_id,
'Qbuzz' as agency_name,
'http://www.qbuzz.nl/' as agency_url,
'Europe/Amsterdam' as agency_timezone,
'nl' as agency_lang
) TO '/tmp/agency.txt' WITH CSV HEADER;

--Workaround to Qbuzz not adhering to the BISION standards by not including seconds
update pujopass set targetdeparturetime = targetdeparturetime||':00',targetarrivaltime = targetarrivaltime||':00' where char_length(targetarrivaltime) = 5;
